const Footer = () => {
  return (
    <footer className="border-t border-white/20 pt-12 sm:pt-16 pb-8 relative z-10 bg-white/10 mt-12 sm:mt-20 backdrop-blur-md">
      <div className="max-w-7xl mx-auto px-4 sm:px-6">
        <div className="flex flex-col md:flex-row justify-between items-center gap-6 mb-8 sm:mb-12">
          ...
          {/* Links */}
          <div className="flex flex-wrap justify-center gap-4 sm:gap-6 text-sm text-white/80 font-medium">
            <a
              href="https://www.tiktok.com/@auralysapp?_r=1&_t=ZN-97Gc5yqa0LW"
